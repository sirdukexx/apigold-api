...
- ทุกคำตอบเป็น **JSON**
- ข้อความอยู่ใน `messages` เป็น array — เรียงจาก **เก่า → ใหม่** ดังนั้น **ข้อความล่าสุดอยู่ท้ายสุดของ array**
- ถ้าใช้ **filter** ข้อความใหม่จะโผล่ก็ต่อเมื่อ **เนื้อหามีคำใน `keywords` ครบตามที่ส่ง** (ไม่ใช่ทุกข้อความในช่อง)
